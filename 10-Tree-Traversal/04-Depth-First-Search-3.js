...
class BinarySearchTree {
   ...
   /**
     * DFS() - Depth First Search (Inorder Traversal)
     *
     * Traversal Order:
     ...
     *
     * 🔑 IMPORTANT:
     * In a Binary Search Tree, inorder traversal
    ...
    DFS(){
        ...
        let data = [];           // Array to store inorder traversal result
        ...
        return data; // Return the inorder traversal result
    }

}

// Testing the BST and DFS traversal (Inorder Traversal)
...
// Output DFS traversal (Inorder Traversal)
