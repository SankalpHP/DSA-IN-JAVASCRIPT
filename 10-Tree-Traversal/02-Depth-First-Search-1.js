...
class BinarySearchTree {
    ...
    DFS(){
        ...
        let data = [];           // Array to store traversal result
        ...
        return data; // Return the preorder traversal result
    }

}

// Testing the BST and DFS traversal (Preorder Traversal)
...
// Output DFS traversal (Preorder Traversal)
